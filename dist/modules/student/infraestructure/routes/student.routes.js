...
// studentRoutes.get("/", studentController.getHelloWorld.bind(studentController));
exports.studentRoutes.get("/:id_student", dependencies_1.studentController.getStudentById.bind(dependencies_1.studentController));
